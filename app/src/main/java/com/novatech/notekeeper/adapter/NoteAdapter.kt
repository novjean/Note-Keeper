package com.novatech.notekeeper.adapter
...
import com.novatech.notekeeper.databinding.NoteLayoutBinding
import com.novatech.notekeeper.fragments.HomeFragmentDirections
...
class NoteAdapter : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NoteAdapter.NoteViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            // since the notes are displayed, we are going to the update note screen
